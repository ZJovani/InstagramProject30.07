        ...
        auth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(RegisterActivity.this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
               if(task.isSuccessful()){
                   ...
                   hm.put("username", username.toLowerCase());
                   hm.put("bio", "");
                   hm.put("imageurl", "https://firebasestorage.googleapis.com/v0/b/instagramproject-871c8.appspot.com/o/profileplaceholder.png?alt=media&token=21c0dbd1-8991-43f8-a42e-025f26e7aa9d");
                   ...
                   reference.setValue(hm).addOnCompleteListener(new OnCompleteListener<Void>() {
                       ...
                       public void onComplete(@NonNull Task<Void> task) {
                           if (task.isSuccessful()) {
                               ...
                               startActivity(intent); //to main activity
                           }
                       }
                   });
               } else{
